...
if __name__ == "__main__":
    rows = 6      # Set the grid rows
    columns = 7   # Set the grid columns
    connectN = 4  # Set the number of pieces in a row needed to win
    targetScore = 3  # Set the target score to win the game
